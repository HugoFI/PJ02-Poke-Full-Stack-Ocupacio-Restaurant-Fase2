        ...
        if ($mesa) {
            if ($mesa['estado'] === 'libre') {
                ...
                if (!$historico || $historico['idUsuario'] != $idUsuario) {
                    ...
                    header('Location: ./unova.php?select=' . $idMesa);
                    exit;
                }
...
try {
    ...
    // ==============================================
    $sql = "SELECT * FROM mesa WHERE idSala = 5";
...
<head>
    <meta charset="utf-8">
    <title>Comedor Unova</title>
    <link rel="stylesheet" href="../../../styles/estilos.css">
    <!-- SweetAlert2 -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body class="body-unova">
    ...
    <div class="sala-buttons">
        <a href="./sinnoh.php" class="btn-link">Sinnoh</a>
        <a href="./unova.php" class="btn-link" disabled>Unova</a>
    </div>
    ...
    <div class="info-sala">
        ...
        <?php if (!$selectedMesa): ?>
            ...
            <ul>
                ...
                <br><br><br>
                <a class="btn-toggle" href="../../historialSala.php?idSala=5">Ver historial de sala</a>
            ...
            <?php else: ?>
                ...
                <form id="form-cambiar-estado" method="post" action="./unova.php?filtro_estado=<?= $filtro_estado ?>&filtro_sillas=<?= $filtro_sillas ?>">
            ...
            <?php else: ?>
                <?php foreach ($mesas as $m): ?>
                    <?php
                        ...
                        $url = "unova.php?select=" . intval($m['idMesa']) . 
