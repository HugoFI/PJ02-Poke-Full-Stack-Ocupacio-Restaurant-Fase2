        ...
        if ($mesa) {
            if ($mesa['estado'] === 'libre') {
                ...
                if (!$historico || $historico['idCamarero'] != $idCamarero) {
                    ...
                    header('Location: ./galar.php?select=' . $idMesa);
                    exit;
                }
...
try {
    ...
    // ==============================================
    $sql = "SELECT * FROM mesa WHERE idSala = 8";
...
<head>
    <meta charset="utf-8">
    <title>Sala Privada Galar</title>
    <link rel="stylesheet" href="../../../styles/estilos.css">
    <!-- SweetAlert2 -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body class="body-galar">

<header>
    <span>Pokéfull Stack | <?php echo $_SESSION['username'];?></span>
    <h1>Sala Privada Galar</h1>
...
<div class="sala-buttons">
    ...
    <a href="./galar.php" class="btn-link" disabled>Galar</a>
...
<div class="contenedor-principal">
    <div class="info-sala">
        ...
        <?php if (!$selectedMesa): ?>
            ...
            <br><br><br>
            <a class="btn-toggle" href="../../historialSala.php?idSala=8">Ver historial de sala</a>
        ...
        <?php else: ?>
            ...
            <form id="form-cambiar-estado" method="post" action="./galar.php?filtro_estado=<?= $filtro_estado ?>&filtro_sillas=<?= $filtro_sillas ?>">
        ...
        <?php else: ?>
            <?php foreach ($mesas as $m): ?>
                <?php
                    ...
                    $url = "galar.php?select=" . intval($m['idMesa']) .
