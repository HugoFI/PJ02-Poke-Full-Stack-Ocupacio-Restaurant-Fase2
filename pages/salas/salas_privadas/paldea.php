        ...
        if ($mesa) {
            if ($mesa['estado'] === 'libre') {
                ...
                if (!$historico || $historico['idUsuario'] != $idUsuario) {
                    ...
                    header('Location: ./paldea.php?select=' . $idMesa);
                    exit;
                }
...
try {
    ...
    // ==============================================
    $sql = "SELECT * FROM mesa WHERE idSala = 9";
...
<head>
    <meta charset="utf-8">
    <title>Sala Paldea</title>
    <link rel="stylesheet" href="./../../../styles/estilos.css">
    <!-- SweetAlert2 -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body class="body-paldea">

    <header>
        <span>Pokéfull Stack | <?php echo $_SESSION['username'];?></span>
        <h1>Sala Privada Paldea</h1>
    ...
    <div class="sala-buttons">
        <a href="./alola.php" class="btn-link">Alola</a>
        <a href="./galar.php" class="btn-link">Galar</a>
        <a href="./kalos.php" class="btn-link">Kalos</a>
        <a href="./paldea.php" class="btn-link" disabled>Paldea</a>
    </div>
    ...
    <div class="info-sala">
        ...
        <?php if (!$selectedMesa): ?>
            ...
            <ul>
                ...
                <br><br><br>
                <a class="btn-toggle" href="../../historialSala.php?idSala=9">Ver historial de sala</a>
            ...
            <?php else: ?>
                ...
                <form id="form-cambiar-estado" method="post" action="./paldea.php?filtro_estado=<?= $filtro_estado ?>&filtro_sillas=<?= $filtro_sillas ?>">
            ...
            <?php else: ?>
                <?php foreach ($mesas as $m): ?>
                    <?php
                        ...
                        $url = "paldea.php?select=" . intval($m['idMesa']) . 
