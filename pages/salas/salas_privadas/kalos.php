        ...
        if ($mesa) {
            if ($mesa['estado'] === 'libre') {
                ...
                if (!$historico || $historico['idUsuario'] != $idUsuario) {
                    ...
                    header('Location: ./kalos.php?select=' . $idMesa);
                    exit;
                }
...
try {
    ...
    // ==============================================
    $sql = "SELECT * FROM mesa WHERE idSala = 6";
...
<body class="body-kalos">
    ...
    <div class="sala-buttons">
        ...
        <a href="./kalos.php" class="btn-link" disabled>Kalos</a>
...
<div class="filtros-bar">
    ...
    <div class="info-sala">
        ...
        <?php if (!$selectedMesa): ?>
            ...
            <br><br><br>
            <a class="btn-toggle" href="../../historialSala.php?idSala=6">Ver historial de sala</a>
            ...
            <?php else: ?>
                ...
                <form id="form-cambiar-estado" method="post" action="./kalos.php?filtro_estado=<?= $filtro_estado ?>&filtro_sillas=<?= $filtro_sillas ?>">
            ...
            <?php else: ?>
                <?php foreach ($mesas as $m): ?>
                    <?php
                        ...
                        $url = "kalos.php?select=" . intval($m['idMesa']) . 
