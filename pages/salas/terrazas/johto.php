        ...
        if ($mesa) {
            if ($mesa['estado'] === 'libre') {
                ...
                if (!$historico || $historico['idUsuario'] != $idUsuario) {
                    ...
                    header('Location: ./johto.php?select=' . $idMesa);
                    exit;
                }
...
try {
    $sql = "SELECT * FROM mesa WHERE idSala = 2";
...
<head>
<meta charset="utf-8">
<title>Terraza Johto</title>
<link rel="stylesheet" href="../../../styles/estilos.css">
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body class="body-johto">
...
<div class="sala-buttons">
    ...
    <a href="./johto.php" class="btn-link" disabled>Johto</a>
...
<div class="contenedor-principal">
    <div class="info-sala">
        ...
        <?php else: ?>
            ...
            <form id="form-cambiar-estado" method="post" action="./johto.php?filtro_estado=<?= $filtro_estado ?>&filtro_sillas=<?= $filtro_sillas ?>">
    ...
    <div class="mesas-container">
        ...
        <?php else: ?>
            <?php foreach($mesas as $m): 
                ...
                $url = "johto.php?select=".intval($m['idMesa'])."&filtro_estado=$filtro_estado&filtro_sillas=$filtro_sillas";
            ?>
